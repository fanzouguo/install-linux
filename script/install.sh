...
# 微信小程序后端服务端口：4000 4001 4002 4003
# 飞书应用后端服务端口：5000 5001 5002 5003
# 微信机器人端口：4999
# 飞书机器人端口：5999
# Mysql 数据库接口：3306
...
ALLOW_PORT=(80 443 3306 27017 28017 3690 9229 3000 3001 3002 3003 3004 3005 3006 3007 3008 3009 4000 4000 4001 4002 4003 4999 5000 5001 5002 5003 5999 8080 9999)
# endregion
...
function initDbMysql() {
	# 获取默认密码
	PWD_DB_ROOT=`sed '/^USER_DB_ROOT=/!d;s/.*=//' /root/.sysconf`
	PWD_DB_DEV=`sed '/^USER_DB_DEV=/!d;s/.*=//' /root/.sysconf`
	PWD_DB_PROD=`sed '/^USER_DB_PROD=/!d;s/.*=//' /root/.sysconf`
}
# 环境清理
function cleanEnv() {
	tipGreen "环境清理"
